...
* **Generate**: The script reads project_config.json and the licence templates (e.g., mmpeula-1.0.txt, mrsl-1.0.txt). It then replaces all placeholder tokens with the values from your configuration file.
...
The generated MMPEULA file (e.g., mmpeula-1.0.txt).
